...
export default function MarkdownBoardBlock({ block, onClick, onResize, onMove, selected = false }: MarkdownBlockProps) {
  return <Rnd
  ...
  >
    <MarkdownRenderer md={block.markdown} className={twMerge("bg-muted rounded p-4 w-full h-full", selected && "border-2 border-green-400")}></MarkdownRenderer>
  </Rnd>
